...
export class GpsService {
    ...
    */
    ...
    // Device del usuario autenticado (vía su trabajador vinculado). Si el trabajador
    // es rastreable y aún no tiene Device, lo crea al vuelo. (Feature de rastreo GPS.)
