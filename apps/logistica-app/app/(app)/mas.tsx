...
const items: Item[] = [
  ...
  { key: 'finanzas', label: 'Finanzas', desc: 'Ingreso, costo y rentabilidad por entrega', href: '/(app)/finanzas', icon: TrendingUp, color: '#16A34A', financeOnly: true },
  { key: 'ganancias-direccion', label: 'Ganancias', desc: 'Cuánto va ganando cada chofer/supervisor', href: '/(app)/ganancias-direccion', icon: Wallet, color: '#0D9488', financeOnly: true },
